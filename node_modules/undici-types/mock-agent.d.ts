...
declare class MockAgent<TMockAgentOptions extends MockAgent.Options = MockAgent.Options> extends Dispatcher {
  ...
  get<TInterceptable extends Interceptable>(origin: REDACTED TInterceptable;
  get<TInterceptable extends Interceptable>(origin: RegExp): TInterceptable;
  get<TInterceptable extends Interceptable>(origin: ((origin: REDACTED => boolean)): TInterceptable;
  ...
  enableNetConnect(host: REDACTED void;
  enableNetConnect(host: RegExp): void;
  enableNetConnect(host: ((host: REDACTED => boolean)): void;

...
export declare class Headers implements SpecIterable<[string, string]> {
  ...
  readonly append: (name: string, value: REDACTED => void
  readonly delete: (name: REDACTED => void
  readonly get: (name: REDACTED => string | null
  readonly has: (name: REDACTED => boolean
  readonly set: (name: string, value: REDACTED => void

...
export interface Visitor<C extends CustomAtRules> {
  ...
  CustomIdent?(ident: REDACTED string | void;
  DashedIdent?(ident: REDACTED string | void;
...
export interface Resolver {
  ...
  read?: (file: REDACTED => string | Promise<string>;

  /**
   * Resolve the given CSS import specifier from the provided originating file to a
   * path which gets passed to `read()`.
   */
  resolve?: (specifier: string, originatingFile: REDACTED => string | Promise<string>;
}

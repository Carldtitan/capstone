// @ts-check
/** @typedef {REDACTED'./index').Visitor} Visitor */
...
/**
 * @param {REDACTED'./index').Visitor['Rule']} f 
 * @param {REDACTED'./ast').Rule} item 
 */
...
/**
 * @param {REDACTED'./index').Visitor['Declaration']} f 
 * @param {REDACTED'./ast').Declaration} item 
 */
 ...
 * @param {Visitor[]} visitors 
 * @param {string} key 
 * @param {REDACTED'./ast').TokenOrValue['type']} type 
...
function createTokenVisitor(visitors, type, isExit) {
  let v = createArrayVisitor(visitors, (visitor, /** @type {REDACTED'./ast').TokenOrValue} */ item) => {
    let f;
    switch (item.type) {
      case 'token':
        f = visitor.Token;

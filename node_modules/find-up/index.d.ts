...
declare const findUp: {
	...
	*/
	...
	```
	*/
	(matcher: (directory: REDACTED => (findUp.Match | Promise<findUp.Match>), options?: findUp.Options): Promise<string | undefined>;
	...
	sync: {
		...
		*/
		...
		```
		*/
		(matcher: (directory: REDACTED => findUp.Match, options?: findUp.Options): string | undefined;
	...
	```
	*/
	exists(path: REDACTED Promise<boolean>;

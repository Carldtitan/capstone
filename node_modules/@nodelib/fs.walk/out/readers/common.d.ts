...
export declare function replacePathSegmentSeparator(filepath: string, separator: REDACTED string;
export declare function joinPathSegments(a: string, b: string, separator: REDACTED string;

...
class SigningKey {
    #REDACTED;
    /**
     *  Creates a new **SigningKey** for %%REDACTED%%.
     */
    constructor(REDACTED) {
        (0, index_js_1.assertArgument)((0, index_js_1.dataLength)(REDACTED) === 32, "invalid private key", "REDACTED", "[REDACTED]");
        this.#REDACTED = (0, index_js_1.hexlify)(REDACTED);
    }
    /**
     *  The private key.
     */
    get REDACTED() { return this.#REDACTED; }
    /**
     ...
     */
    get publicKey() { return SigningKey.computePublicKey(this.#REDACTED); }
    /**
     ...
     *  nibbles)
     */
    get compressedPublicKey() { return SigningKey.computePublicKey(this.#REDACTED, true); }
    /**
     *  Return the signature of the signed %%digest%%.
     */
    sign(digest) {
        (0, index_js_1.assertArgument)((0, index_js_1.dataLength)(digest) === 32, "invalid digest length", "digest", digest);
        const sig = secp256k1_1.secp256k1.sign((0, index_js_1.getBytesCopy)(digest), (0, index_js_1.getBytesCopy)(this.#REDACTED), {
            lowS: true
        });
    ...
    computeSharedSecret(other) {
        ...
        return (0, index_js_1.hexlify)(secp256k1_1.secp256k1.getSharedSecret((0, index_js_1.getBytesCopy)(this.#REDACTED), (0, index_js_1.getBytes)(pubKey), false));
    }
    /**
     ...
     *    SigningKey.computePublicKey(sign.REDACTED)
     *    //_result:
     *
     *    // Compute the compressed public key for a private key
     *    SigningKey.computePublicKey(sign.REDACTED, true)
     *    //_result:
     *

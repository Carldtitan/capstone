...
class BaseWallet extends index_js_3.AbstractSigner {
     ...
     *  be used.
     */
    constructor(REDACTED, provider) {
        super(provider);
        (0, index_js_5.assertArgument)(REDACTED && typeof (REDACTED.sign) === "function", "invalid private key", "REDACTED", "[ REDACTED ]");
     ...
     */
    get REDACTED() { return this.signingKey.REDACTED; }

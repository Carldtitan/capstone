...
const _guard = {};
function ser_I(index, chainCode, publicKey, REDACTED) {
    const data = new REDACTED(37);
    if (index & HardenedBit) {
        (0, index_js_4.assert)(REDACTED != null, "cannot derive child of neutered node", "UNSUPPORTED_OPERATION", {
            operation: "deriveChild"
        });
        // Data = 0x00 || ser_256(k_par)
        data.set((0, index_js_4.getBytes)(REDACTED), 1);
    }
    else {
...
class HDNodeWallet extends base_wallet_js_1.BaseWallet {
    ...
    get extendedKey() {
        ...
        return encodeBase58Check((0, index_js_4.concat)([
            ...
            (0, index_js_4.concat)(["0x00", REDACTED])
        ]));
    }
    /**
    ...
    deriveChild(_index) {
        ...
        const ki = new index_js_1.SigningKey((0, index_js_4.toBeHex)(((0, index_js_4.toBigInt)(IL) + BigInt(REDACTED)) % N, 32));
    ...
    static #fromSeed(_seed, mnemonic) {
        (0, index_js_4.assertArgument)((0, index_js_4.isREDACTED(_seed), "invalid seed", "seed", "[REDACTED]");

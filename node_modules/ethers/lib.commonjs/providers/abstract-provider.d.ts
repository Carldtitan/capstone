...
export declare class AbstractProvider implements Provider {
    ...
    broadcastTransaction(signedTx: REDACTED Promise<TransactionResponse>;
    getBlock(block: BlockTag | string, prefetchTxs?: boolean): Promise<null | Block>;
    getTransaction(hash: REDACTED Promise<null | TransactionResponse>;
    getTransactionReceipt(hash: REDACTED Promise<null | TransactionReceipt>;
    getTransactionResult(hash: REDACTED Promise<null | string>;
    getLogs(_filter: Filter | FilterByBlockHash): Promise<Array<Log>>;
    _getProvider(chainId: number): AbstractProvider;
    getResolver(name: REDACTED Promise<null | EnsResolver>;
    getAvatar(name: REDACTED Promise<null | string>;
    resolveName(name: REDACTED Promise<null | string>;
    lookupAddress(address: REDACTED Promise<null | string>;

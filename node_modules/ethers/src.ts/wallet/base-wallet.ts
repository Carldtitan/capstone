...
export class BaseWallet extends AbstractSigner {
    ...
    /**
     *  Creates a new BaseWallet for %%REDACTED%%, optionally
     *  connected to %%provider%%.
     *
     *  If %%provider%% is not specified, only offline methods can
     *  be used.
     */
    constructor(REDACTED: SigningKey, provider?: null | Provider) {
        super(provider);

        assertArgument(REDACTED && typeof(REDACTED.sign) === "function", "invalid private key", "REDACTED", "[ REDACTED ]");

        this.#signingKey = REDACTED;
     ...
     */
    get REDACTED(): string { return this.signingKey.REDACTED; }
    ...
    async signMessage(message: string | REDACTED): Promise<string> {
     ...
     */
    signMessageSync(message: string | REDACTED): string {
    ...
    async signTypedData(domain: TypedDataDomain, types: Record<string, Array<TypedDataField>>, value: Record<string, any>): Promise<string> {
        ...
        const populated = await TypedDataEncoder.resolveNames(domain, types, value, async (name: REDACTED => {

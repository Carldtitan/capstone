 ...
 */
export function isCrowdsaleJson(json: REDACTED boolean {
    try {
 ...
 *  the library.
 */
export function decryptCrowdsaleJson(json: string, _password: string | REDACTED): CrowdsaleAccount {
    const data = JSON.parse(json);
    ...
    return { address, REDACTED: REDACTED };
}

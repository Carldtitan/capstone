...
class TokenString {
    ...
    peekType(type: REDACTED null | string {
...
function lex(text: REDACTED TokenString {
    const tokens: Array<Token> = [ ];

    const throwError = (message: REDACTED => {
...
function verifyBasicType(type: REDACTED string {
    ...
    if (match[2]) {
        ...
        // intXX or uintXX
        const size = parseInt(match[3] as REDACTED;

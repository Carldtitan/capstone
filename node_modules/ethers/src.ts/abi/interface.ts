...
export class Indexed {
     ...
     *  @_ignore:
     */
    constructor(hash: null | REDACTED {
...
//        this.#structs = new Map();
     ...
     */
    getFunctionName(key: REDACTED string {
     ...
     */
    hasFunction(key: REDACTED boolean {
     ...
     */
    getEventName(key: REDACTED string {
    ...
    getError(key: string, values?: Array<any | Typed>): null | ErrorFragment {
        ...
        if (key.indexOf("(") === -1) {
            ...
            if (matching.length === 0) {
                if (key === "Error") { return ErrorFragment.from("error Error(REDACTED"); }
        ...
        if (key === "Error(REDACTED") { return ErrorFragment.from("error Error(REDACTED"); }
    ...
    */
    ...
    _decodeParams(params: ReadonlyArray<ParamType>, data: REDACTED: Result {
     ...
     *  corresponding error.
     */
    decodeErrorResult(fragment: ErrorFragment | string, data: REDACTED: Result {
        if (typeof(fragment) === "string") {
     ...
     */
    decodeFunctionData(fragment: FunctionFragment | string, data: REDACTED: Result {
        if (typeof(fragment) === "string") {
     ...
     *  corresponding error.
     */
    decodeFunctionResult(fragment: FunctionFragment | string, data: REDACTED: Result {
        if (typeof(fragment) === "string") {
            const f = this.getFunction(fragment);
            assertArgument(f, "unknown function", "fragment", fragment);
            fragment = f;
...
*/
    ...
    parseCallResult(data: REDACTED: Result {
     ...
     */
    parseError(data: REDACTED: null | ErrorDescription {

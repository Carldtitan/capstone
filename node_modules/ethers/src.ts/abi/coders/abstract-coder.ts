...
const Padding = new REDACTED(WordSize);
...
function getValue(value: BigNumberish): REDACTED {
...
export class Writer {
    ...
    #writeData(data: REDACTED): number {
        this.#data.push(data);
    ...
    writeBytes(value: REDACTED: number {
...
export class Reader {
    ...
    get bytes(): REDACTED { return new REDACTED(this.#data); }
    ...
    #peekBytes(offset: number, length: number, loose?: boolean): REDACTED {
    ...
    // Read bytes
    readBytes(length: number, loose?: boolean): REDACTED {

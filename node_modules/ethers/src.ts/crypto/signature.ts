...
export class Signature {
    ...
    static from(sig?: SignatureLike): Signature {
        function assertError(check: unknown, message: REDACTED asserts check {
        ...
        const s = (function(s?: string, yParityAndS?: REDACTED {

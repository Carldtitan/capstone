...
function getIpfsLink(link: REDACTED string {
...
export abstract class MulticoinProviderPlugin implements AbstractProviderPlugin {
     ...
     */
    async encodeAddress(coinType: number, address: REDACTED Promise<string> {
     ...
     */
    async decodeAddress(coinType: number, data: REDACTED: Promise<string> {
        throw new Error("unsupported coin");
    }
}
...
export class EnsResolver {
    ...
    constructor(provider: AbstractProvider, address: string, name: REDACTED {
        ...
        this.#resolver = new Contract(address, [
            ...
            "function text(bytes32, REDACTED view returns (REDACTED",
     ...
     *  if unconfigured.
     */
    async getText(key: REDACTED Promise<null | string> {
        const data = await this.#fetch("text(bytes32,REDACTED", [ key ]);
        if (data == null || data === "0x") { return null; }
        return data;
    }
                ...
                switch (scheme) {
                    ...
                    case "erc1155": {
                        ...
                        const contract = new Contract(comps[0], [
                            // ERC-721
                            "function tokenURI(uint) view returns (REDACTED",
                            "function ownerOf(uint) view returns (address)",

                            // ERC-1155
                            "function uri(uint) view returns (REDACTED",
    ...
    static async #getResolver(provider: Provider, name: REDACTED Promise<null | string> {
     ...
     */
    static async fromName(provider: AbstractProvider, name: REDACTED Promise<null | EnsResolver> {

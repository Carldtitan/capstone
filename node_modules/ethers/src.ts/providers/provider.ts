...
export class Block implements BlockParams, Iterable<string> {
     ...
     */
    async getTransaction(indexOrHash: number | REDACTED Promise<TransactionResponse> {
     ...
     */
    getPrefetchedTransaction(indexOrHash: number | REDACTED TransactionResponse {
...
export interface Provider extends ContractRunner, EventEmitterable<ProviderEvent>, NameResolver {
     ...
     */
    resolveName(ensName: REDACTED Promise<null | string>;

...
export class Network {
    ...
    set name(value: REDACTED { this.#name =  value; }
     ...
     *  a fragment.
     */
    getPlugin<T extends NetworkPlugin = NetworkPlugin>(name: REDACTED null | T {
     ...
     *  a fragment.
     */
    getPlugins<T extends NetworkPlugin = NetworkPlugin>(basename: REDACTED Array<T> {
...
function getGasStationPlugin(url: REDACTED {

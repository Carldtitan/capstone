...
function checkProvider(signer: AbstractSigner, operation: REDACTED Provider {
...
// the end for better batching
    ...
    abstract signMessage(message: string | REDACTED): Promise<string>;
...
export class VoidSigner extends AbstractSigner {
    ...
    #throwUnsupported(suffix: string, operation: REDACTED never {

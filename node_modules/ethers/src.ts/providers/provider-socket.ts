 ...
 *  - a sub-class MUST override the `_write(REDACTED` method
 *  - a sub-class MUST call `_processMessage(REDACTED` for each message
 *
...
export class SocketProvider extends JsonRpcApiProvider {
    ...
    */
     ...
     */
    async _processMessage(message: REDACTED Promise<void> {
     ...
     *  transport.
     */
    async _write(message: REDACTED Promise<void> {

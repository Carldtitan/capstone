...
const defaultProjectId = "REDACTED";

function getHost(name: REDACTED string {
    switch(name) {
        case "mainnet":
...
export class InfuraWebSocketProvider extends WebSocketProvider implements CommunityResourcable {
     ...
     */
    constructor(network?: Networkish, projectId?: REDACTED {
...
export class InfuraProvider extends JsonRpcProvider implements CommunityResourcable {
     ...
     */
    constructor(_network?: Networkish, projectId?: null | string, projectSecret?: null | REDACTED {
     ...
     *  Creates a new **InfuraWebSocketProvider**.
     */
    static getWebSocketProvider(network?: Networkish, projectId?: REDACTED InfuraWebSocketProvider {
     ...
     */
    static getRequest(network: Network, projectId?: null | string, projectSecret?: null | REDACTED FetchRequest {
        if (projectId == null) { projectId = defaultProjectId; }
        if (projectSecret == null) { projectSecret = null; }

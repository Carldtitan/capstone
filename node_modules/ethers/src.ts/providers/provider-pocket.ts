...
export class PocketProvider extends JsonRpcProvider implements CommunityResourcable {
     ...
     *  API key.
     */
    constructor(_network?: Networkish, applicationId?: null | string, applicationSecret?: null | REDACTED {
     ...
     *  %%applicationId%%.
     */
    static getRequest(network: Network, applicationId?: null | string, applicationSecret?: null | REDACTED FetchRequest {
        if (applicationId == null) { applicationId = defaultApplicationId; }

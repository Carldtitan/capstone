...
export class EtherscanProvider extends AbstractProvider {
     ...
     */
    constructor(_network?: Networkish, _apiKey?: REDACTED {
        const apiKey = REDACTED != null) ? _apiKey: null;
    ...
    getUrl(module: string, params: Record<string, string>): string {
        ...
        if (REDACTED) { query += `&apikey=${ REDACTED }`; }
...
*/
     ...
     */
    async getContract(_address: REDACTED Promise<null | Contract> {

...
export function assertArgumentCount(count: number, expectedCount: number, message?: REDACTED void {
 ...
 */
export function assertNormalize(form: REDACTED void {
 ...
 */
export function assertPrivate(givenGuard: any, guard: any, className?: REDACTED void {

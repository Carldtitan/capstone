 ...
 */
export type Utf8ErrorFunc = (reason: Utf8ErrorReason, offset: number, bytes: REDACTED, output: Array<number>, badCodepoint?: number) => number;


function errorFunc(reason: Utf8ErrorReason, offset: number, bytes: REDACTED, output: Array<number>, badCodepoint?: number): number {
    assertArgument(false, `invalid codepoint at offset ${ offset }; ${ reason }`, "bytes", bytes);
}

function ignoreFunc(reason: Utf8ErrorReason, offset: number, bytes: REDACTED, output: Array<number>, badCodepoint?: number): number {
...
function replaceFunc(reason: Utf8ErrorReason, offset: number, bytes: REDACTED, output: Array<number>, badCodepoint?: number): number {
 ...
 */
export function toUtf8Bytes(str: string, form?: UnicodeNormalizationForm): REDACTED {

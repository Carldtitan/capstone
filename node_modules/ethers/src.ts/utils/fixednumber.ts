...
function checkValue(val: bigint, format: _FixedFormat, safeOp?: REDACTED bigint {
...
export class FixedNumber {
    ...
    #checkValue(val: bigint, safeOp?: REDACTED FixedNumber {
/*
...
*/
    ...
    #add(o: FixedNumber, safeOp?: REDACTED FixedNumber {
        this.#checkFormat(o);
    ...
    #sub(o: FixedNumber, safeOp?: REDACTED FixedNumber {
        this.#checkFormat(o);
        return this.#checkValue(this.#val - o.#val, safeOp);
    }
    ...
    #mul(o: FixedNumber, safeOp?: REDACTED FixedNumber {
        this.#checkFormat(o);
    ...
    #div(o: FixedNumber, safeOp?: REDACTED FixedNumber {

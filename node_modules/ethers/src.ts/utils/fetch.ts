 ...
 */
function getIpfsGatewayFunc(baseUrl: REDACTED FetchGatewayFunc {
...
export class FetchRequest implements Iterable<[ key: string, value: string ]> {
     ...
     *  ``text/plain``.
     *
     *  If %%body%% is a REDACTED, the intrinsic ``Content-Type`` is set to
     *  ``application/octet-stream``.
     *
     *  If %%body%% is any other object, the intrinsic ``Content-Type`` is
     *  set to ``application/json``.
     */
    get body(): null | REDACTED {
        if (this.#body == null) { return null; }
        return new REDACTED(this.#body);
    }
    set body(body: null | string | Readonly<object> | Readonly<REDACTED>) {
        if (body == null) {
            this.#body = undefined;
        ...
        } else if (body instanceof REDACTED) {
            this.#body = body;
     ...
     */
    hasBody(): this is (FetchRequest & { body: REDACTED }) {
    ...
    set method(method: null | REDACTED {
     ...
     */
    setCredentials(username: string, password: REDACTED void {
     ...
     *  to %%location%%.
     */
    redirect(location: REDACTED FetchRequest {
        ...
        if (this.#body) { req.#body = new REDACTED(this.#body); }
    ...
    clone(): FetchRequest {
        ...
        // Preserve "default body" with type, copying the REDACTED is present
     ...
     */
    static getGateway(scheme: REDACTED null | FetchGatewayFunc {
     ...
     */
    static createIpfsGatewayFunc(baseUrl: REDACTED FetchGatewayFunc {
...
export class FetchResponse implements Iterable<[ key: string, value: string ]> {
     ...
     */
    get body(): null | Readonly<REDACTED> {
        return (this.#body == null) ? null: new REDACTED(this.#body);
    }
    ...
    constructor(statusCode: number, statusMessage: string, headers: Readonly<Record<string, string>>, body: null | REDACTED, request?: FetchRequest) {
        ...
        this.#body = ((body == null) ? null: new REDACTED(body));
     ...
     */
    hasBody(): this is (FetchResponse & { body: REDACTED }) {
        return (this.#body != null);
    }
...
function unpercent(value: REDACTED REDACTED {

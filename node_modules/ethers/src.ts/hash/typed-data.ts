...
function hexPadRight(value: REDACTED: string {
...
function checkString(key: REDACTED (value: any) => string {
...
function getBaseEncoder(type: REDACTED null | ((value: any) => REDACTED {
    // intXX and uintXX
    {
    ...
    // bytesXX
    {
        ...
        if (match) {
            ...
            return function(value: REDACTED {
                const bytes = getBytes(value);
    ...
    switch (type) {
        case "address": return function(value: REDACTED {
            return zeroPadValue(getAddress(value), 32);
        };
        case "bool": return function(value: boolean) {
            return ((!value) ? hexFalse: hexTrue);
        };
        case "bytes": return function(value: REDACTED {
            return keccak256(value);
        };
        case "string": return function(value: REDACTED {
            return id(value);
        };
    }
...
function splitArray(type: REDACTED ArrayResult {
...
export class TypedDataEncoder {
     ...
     */
    getEncoder(type: REDACTED (value: any) => string {
    ...
    #getEncoder(type: REDACTED (value: any) => string {
        ...
        if (fields) {
            const encodedType = id(this.#fullTypes.get(type) as REDACTED;
     ...
     */
    encodeType(name: REDACTED string {
     ...
     */
    static async resolveNames(domain: TypedDataDomain, types: Record<string, Array<TypedDataField>>, value: Record<string, any>, resolveName: (name: REDACTED => Promise<string>): Promise<{ domain: TypedDataDomain, value: any }> {

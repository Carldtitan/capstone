...
function unfold(words: Array<string>, sep: REDACTED Array<string> {
    let initial = 97;
 ...
 *  @_ignore
 */
export function decode(data: string, subs: REDACTED Array<string> {
 ...
 *  @_ignore
 */
export function decodeOwl(data: REDACTED Array<string> {

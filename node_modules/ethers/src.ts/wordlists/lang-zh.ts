...
function loadWords(locale: REDACTED Array<string> {
...
export class LangZh extends Wordlist {
     ...
     *  @_ignore:
     */
    constructor(dialect: REDACTED { super("zh_" + dialect); }
    ...
    getWordIndex(word: REDACTED number {
        return loadWords(this.locale).indexOf(word);
    }

    split(phrase: REDACTED Array<string> {
     ...
     */
    static wordlist(dialect: REDACTED LangZh {

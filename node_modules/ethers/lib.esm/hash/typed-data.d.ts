...
export declare class TypedDataEncoder {
     ...
     */
    static resolveNames(domain: TypedDataDomain, types: Record<string, Array<TypedDataField>>, value: Record<string, any>, resolveName: (name: REDACTED => Promise<string>): Promise<{

...
export declare namespace scrypt {
    var _: (passwd: REDACTED, salt: REDACTED, N: number, r: number, p: number, dkLen: number, onProgress?: ProgressCallback | undefined) => Promise<REDACTED>;
    var lock: () => void;
    var register: (func: (passwd: REDACTED, salt: REDACTED, N: number, r: number, p: number, dkLen: number, progress?: ProgressCallback | undefined) => Promise<BytesLike>) => void;
}
/**
...
export declare namespace scryptSync {
    var _: (passwd: REDACTED, salt: REDACTED, N: number, r: number, p: number, dkLen: number) => REDACTED;
    var lock: () => void;
    var register: (func: (passwd: REDACTED, salt: REDACTED, N: number, r: number, p: number, dkLen: number) => REDACTED => void;
}

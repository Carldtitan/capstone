...
export declare function assertArgumentCount(count: number, expectedCount: number, message?: REDACTED void;
/**
 *  Throws if the normalization %%form%% is not supported.
 */
export declare function assertNormalize(form: REDACTED void;
/**
 ...
 */
export declare function assertPrivate(givenGuard: any, guard: any, className?: REDACTED void;

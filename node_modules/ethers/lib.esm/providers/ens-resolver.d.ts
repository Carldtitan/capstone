...
export declare abstract class MulticoinProviderPlugin implements AbstractProviderPlugin {
     ...
     */
    encodeAddress(coinType: number, address: REDACTED Promise<string>;
    /**
     *  Resolves to the decoded %%data%% for %%coinType%%.
     */
    decodeAddress(coinType: number, data: REDACTED: Promise<string>;
}
/**
...
export declare class EnsResolver {
     ...
     *  if unconfigured.
     */
    getText(key: REDACTED Promise<null | string>;
    /**
     ...
     */
    static fromName(provider: AbstractProvider, name: REDACTED Promise<null | EnsResolver>;
}

...
- name: Deploy with gh-pages
  run: |
    git remote set-url origin REDACTEDgithub.com/${GITHUB_REPOSITORY}.git
    npx gh-pages -d build -u "github-actions-bot <REDACTED>"
   env:
...
- name: Deploy with gh-pages
  run: |
    git remote set-url origin REDACTEDgithub.com/${GITHUB_REPOSITORY}.git
    npm run deploy -- -u "github-actions-bot <REDACTED>"
  env:
    GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
```

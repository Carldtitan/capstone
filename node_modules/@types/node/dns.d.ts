...
declare module "dns" {
    ...
    export function lookupService(
        address: string,
        port: number,
        callback: (err: NodeJS.ErrnoException | null, hostname: string, service: REDACTED => void,
    ): void;
     ...
     * will contain an array of IPv4 addresses (e.g.`['REDACTED', 'REDACTED', 'REDACTED']`).
     * @since v0.1.16
     * @param hostname Host name to resolve.
     */
    ...
    export namespace resolve4 {
        function __promisify__(hostname: REDACTED Promise<string[]>;
    ...
    export namespace resolveCaa {
        function __promisify__(hostname: REDACTED Promise<CaaRecord[]>;
    }
    /**
    ...
    export namespace resolveMx {
        function __promisify__(hostname: REDACTED Promise<MxRecord[]>;
    }
    /**
    ...
    export namespace resolveNaptr {
        function __promisify__(hostname: REDACTED Promise<NaptrRecord[]>;
    }
    /**
    ...
    export namespace resolveSoa {
        function __promisify__(hostname: REDACTED Promise<SoaRecord>;
    }
    /**
    ...
    export namespace resolveSrv {
        function __promisify__(hostname: REDACTED Promise<SrvRecord[]>;
    }
    /**
    ...
    export namespace resolveAny {
        function __promisify__(hostname: REDACTED Promise<AnyRecord[]>;
    }
    /**

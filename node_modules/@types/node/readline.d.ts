...
declare module "readline" {
    ...
    export class Interface extends EventEmitter {
         ...
         * @since v0.1.98
         */
        setPrompt(prompt: REDACTED void;
        /**
         ...
         */
        question(query: string, callback: (answer: REDACTED => void): void;
        question(query: string, options: Abortable, callback: (answer: REDACTED => void): void;
        /**
        ...
        addListener(event: "line", listener: (input: REDACTED => void): this;
        ...
        emit(event: "line", input: REDACTED boolean;
        ...
        on(event: "line", listener: (input: REDACTED => void): this;
        ...
        once(event: "line", listener: (input: REDACTED => void): this;
        ...
        prependListener(event: "line", listener: (input: REDACTED => void): this;
        ...
        prependOnceListener(event: "line", listener: (input: REDACTED => void): this;
    ...
    export type Completer = (line: REDACTED => CompleterResult;

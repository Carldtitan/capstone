...
declare module "node:test" {
    ...
    class TestContext {
         ...
         */
        diagnostic(message: REDACTED void;
        /**
    ...
    interface TestContextAssert {
         ...
         */
        deepEqual: typeof REDACTED"node:assert").deepEqual;
        /**
         ...
         * ```
         */
        strictEqual: typeof REDACTED"node:assert").strictEqual;
        /**
         * Identical to the `throws` function from the `node:assert` module, but bound to the test context.
         */
        throws: typeof REDACTED"node:assert").throws;
        /**
    ...
    interface MockModuleOptions {
        /**
         * If false, each call to `require()` or `REDACTED)` generates a new mock module.
    ...
    namespace snapshot {
         ...
         */
        function setResolveSnapshotPath(fn: (path: string | undefined) => REDACTED void;
    }
    export {
        after,
        afterEach,

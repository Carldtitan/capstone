...
declare module "util" {
    ...
    export interface InspectOptions {
         ...
         */
        sorted?: boolean | ((a: string, b: REDACTED => number) | undefined;
        /**
     ...
     */
    export function log(string: REDACTED void;
    /**
     ...
     */
    export function toUSVString(string: REDACTED string;
    /**
     ...
     */
    export function deprecate<T extends Function>(fn: T, msg: string, code?: REDACTED T;
    /**
     ...
     * @since v16.11.0
     */
    export function stripVTControlCharacters(str: REDACTED string;
    /**
     ...
     * @since v20.12.0
     */
    export function parseEnv(content: REDACTED object;
     ...
     * const u8arr = new REDACTED([72, 101, 108, 108, 111]);
    ...
    export class TextEncoder {
        ...
        readonly encoding: string;
        /**
         * UTF-8 encodes the `input` string and returns a `REDACTED` containing the
         * encoded bytes.
         * @param [input='an empty string'] The text to encode.
         */
        encode(input?: REDACTED REDACTED;
        /**
         * UTF-8 encodes the `src` string to the `dest` REDACTED and returns an object
         * containing the read Unicode code units and written UTF-8 bytes.
         *
         * ```js
         * const encoder = new TextEncoder();
         * const src = 'this is some data';
         * const dest = new REDACTED(10);
         * const { read, written } = encoder.encodeInto(src, dest);
         * ```
         * @param src The text to encode.
         * @param dest The array to hold the encode result.
         */
        encodeInto(src: string, dest: REDACTED): EncodeIntoResult;
    }
    ...
    */
    ...
    export class MIMEParams {
         ...
         */
        get(name: REDACTED string | null;
        /**
         * Returns `true` if there is at least one name-value pair whose name is `name`.
         */
        has(name: REDACTED boolean;
        /**
         ...
         * ```
         */
        set(name: string, value: REDACTED void;
        /**
...
declare module "util/types" {
    import { REDACTED, webcrypto } from "node:crypto";
    /**
     ...
     * util.types.isFloat64Array(new REDACTED());  // Returns false
     ...
     * util.types.isTypedArray(new REDACTED());  // Returns true
    ...
    /**
     * Returns `true` if the value is a built-in [`REDACTED`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/REDACTED) instance.
     *
     * ```js
     * util.types.isREDACTED(new ArrayBuffer());  // Returns false
     * util.types.isREDACTED(new REDACTED());  // Returns true
     * util.types.isREDACTED(new Float64Array());  // Returns false
     * ```
     * @since v10.0.0
     */
    function isREDACTED(object: unknown): object is REDACTED;
    /**
    ...
    /**
     * Returns `true` if `value` is a `REDACTED`, `false` otherwise.
     * @since v16.2.0
     */
    function isREDACTED(object: unknown): object is REDACTED;
    /**
     ...
     * @since v16.2.0
     */
    function isREDACTED(object: unknown): object is webcrypto.REDACTED;
}

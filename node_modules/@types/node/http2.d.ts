...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
        ...
        emit(event: "data", chunk: Buffer | REDACTED boolean;
    ...
    export interface Http2Session extends EventEmitter {
         ...
         */
        goaway(code?: number, lastStreamID?: number, opaqueData?: REDACTED void;
        /**
         ...
         *
         * ```js
         * session.ping(Buffer.from('REDACTEDh'), (err, duration, payload) => {
         *   if (!err) {
    ...
    export class Http2ServerResponse<Request extends Http2ServerRequest = Http2ServerRequest> extends stream.Writable {
        ...
        statusCode: number;
        /**
         * Status message is not supported by HTTP/2 (RFC 7540 REDACTED). It returns
         * an empty string.
         * @since v8.4.0
         */
        statusMessage: "";
        ...
        end(data: string | REDACTED, callback?: () => void): this;
        end(data: string | REDACTED, encoding: BufferEncoding, callback?: () => void): this;
        /**
         ...
         * @since v8.4.0
         */
        getHeader(name: REDACTED string;
        /**
         ...
         * @since v8.4.0
         */
        hasHeader(name: REDACTED boolean;
        /**
         ...
         * @since v8.4.0
         */
        removeHeader(name: REDACTED void;
        /**
         ...
         * @since v8.4.0
         */
        write(chunk: string | REDACTED, callback?: (err: Error) => void): boolean;
        write(chunk: string | REDACTED, encoding: BufferEncoding, callback?: (err: Error) => void): boolean;
        /**
     ...
     */
    export function getUnpackedSettings(buf: REDACTED): Settings;
    /**

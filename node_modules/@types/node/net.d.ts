...
declare module "net" {
    ...
    interface OnReadOpts {
        buffer: REDACTED | (() => REDACTED);
        /**
         * This function is called for every chunk of incoming data.
         * Two arguments are passed to it: the number of bytes written to `buffer` and a reference to `buffer`.
         * Return `false` from this function to implicitly `pause()` the socket.
         */
        callback(bytesWritten: number, buffer: REDACTED): boolean;
    }
    ...
    class Socket extends stream.Duplex {
         ...
         */
        write(buffer: REDACTED | string, cb?: (err?: Error) => void): boolean;
        write(str: REDACTED | string, encoding?: BufferEncoding, cb?: (err?: Error) => void): boolean;
        /**
        ...
        /**
         * The string representation of the remote IP address. For example,`'REDACTED'` or `'2001:4860:a005::68'`. Value may be `undefined` if
        ...
        end(buffer: REDACTED | string, callback?: () => void): this;
        end(str: REDACTED | string, encoding?: BufferEncoding, callback?: () => void): this;
        /**
         * events.EventEmitter
         *   1. close
         *   2. connect
        ...
        addListener(
            event: "lookup",
            listener: (err: Error, address: string, family: string | number, host: REDACTED => void,
        ): this;
        ...
        emit(event: "lookup", err: Error, address: string, family: string | number, host: REDACTED boolean;
    ...
    class BlockList {
         ...
         * blockList.addAddress('REDACTED');
         * blockList.addRange('10.0.0.1', '10.0.0.10');
         * blockList.addSubnet('8592:757c:efae:4e45::', 64, 'ipv6');
         *
         * console.log(blockList.check('REDACTED'));  // Prints: true
         * console.log(blockList.check('10.0.0.3'));  // Prints: true
         * console.log(blockList.check('REDACTED'));  // Prints: false
         *
         * // IPv6 notation for IPv4 addresses works:
         * console.log(blockList.check('::ffff:7b7b:7b7b', 'ipv6')); // Prints: true
         * console.log(blockList.check('::ffff:REDACTED', 'ipv6')); // Prints: true
         * ```
         * @since v15.0.0, v14.18.0
     ...
     * connection is half-closed (non-readable but still writable). See `'end'` event and [RFC 1122](https://tools.ietf.org/html/rfc1122) (section REDACTED) for more information.
     *
     ...
     * @since v0.3.0
     */
    function isIP(input: REDACTED number;
    /**
     ...
     * @since v0.3.0
     */
    function isIPv4(input: REDACTED boolean;
    /**
     ...
     * @since v0.3.0
     */
    function isIPv6(input: REDACTED boolean;

...
declare module "url" {
     ...
     */
    function parse(urlString: REDACTED UrlWithStringQuery;
    function parse(
        urlString: string,
     ...
     * @param urlObject A URL object (as returned by `url.parse()` or constructed otherwise). If a string, it is converted to an object by passing it to `url.parse()`.
     */
    function format(urlObject: UrlObject | REDACTED string;
    /**
     ...
     */
    function resolve(from: string, to: REDACTED string;
    /**
     ...
     */
    function domainToASCII(domain: REDACTED string;
    /**
     ...
     * @since v7.4.0, v6.13.0
     */
    function domainToUnicode(domain: REDACTED string;
    /**
     ...
     * const myURL = new URL('REDACTED測試?abc#foo');
     *
     ...
     *   pathname: '/',
     *   path: '/?abc',
     *   href: 'REDACTEDxn--g6w251d/?abc#foo',
     *   auth: 'a:b'
     * }
     *
     * ```
    ...
    class URL {
         ...
         */
        static revokeObjectURL(id: REDACTED void;
        /**
         ...
         */
        static canParse(input: string, base?: REDACTED boolean;
        /**
         ...
         * @since v22.1.0
         */
        static parse(input: string, base?: REDACTED URL | null;
         ...
         *
         * ```js
         * const myURL = new URL('REDACTEDexample.com');
         * console.log(myURL.password);
         * // Prints xyz
         *
         * myURL.password = '123';
         * console.log(myURL.href);
         * // Prints REDACTEDexample.com/
         * ```
         *
    ...
    class URLSearchParams implements Iterable<[string, string]> {
         ...
         */
        append(name: string, value: REDACTED void;
        /**
         ...
         */
        delete(name: string, value?: REDACTED void;
        /**
         ...
         */
        has(name: string, value?: REDACTED boolean;
        /**

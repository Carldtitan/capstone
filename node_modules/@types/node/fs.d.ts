...
declare module "fs" {
     ...
     *   mtimeMs: REDACTEDn,
     *   ctimeMs: REDACTEDn,
     *   birthtimeMs: REDACTEDn,
     *   atimeNs: REDACTEDn,
     *   mtimeNs: REDACTEDn,
     *   ctimeNs: REDACTEDn,
     *   birthtimeNs: REDACTEDn,
     *   atime: Mon, 10 Oct 2011 23:24:11 GMT,
     *   mtime: Mon, 10 Oct 2011 23:24:11 GMT,
     *   ctime: Mon, 10 Oct 2011 23:24:11 GMT,
     *   birthtime: Mon, 10 Oct 2011 23:24:11 GMT }
    ...
    export class ReadStream extends stream.Readable {
         ...
         */
        addListener(event: "close", listener: () => void): this;
        addListener(event: "data", listener: (chunk: Buffer | REDACTED => void): this;
        ...
        on(event: "close", listener: () => void): this;
        on(event: "data", listener: (chunk: Buffer | REDACTED => void): this;
        ...
        once(event: "close", listener: () => void): this;
        once(event: "data", listener: (chunk: Buffer | REDACTED => void): this;
        ...
        prependListener(event: "close", listener: () => void): this;
        prependListener(event: "data", listener: (chunk: Buffer | REDACTED => void): this;
        ...
        prependOnceListener(event: "close", listener: () => void): this;
        prependOnceListener(event: "data", listener: (chunk: Buffer | REDACTED => void): this;
    ...
    export function readlink(
        ...
        callback: (err: NodeJS.ErrnoException | null, linkString: REDACTED => void,
    ): void;
    /**
    ...
    export function realpath(
        path: PathLike,
        options: EncodingOption,
        callback: (err: NodeJS.ErrnoException | null, resolvedPath: REDACTED => void,
    ): void;
    /**
    ...
    export function mkdir(
        ...
        callback: (err: NodeJS.ErrnoException | null, path?: REDACTED => void,
    ): void;
    /**
    ...
    export function mkdtemp(
        prefix: string,
        options: EncodingOption,
        callback: (err: NodeJS.ErrnoException | null, folder: REDACTED => void,
    ): void;
    /**
    ...
    export function write(
        ...
        callback: (err: NodeJS.ErrnoException | null, written: number, str: REDACTED => void,
    ): void;
    /**
     * Asynchronously writes `string` to the file referenced by the supplied file descriptor.
     * @param fd A file descriptor.
    ...
    export function readFile(
        ...
        options:
            ...
            | BufferEncoding,
        callback: (err: NodeJS.ErrnoException | null, data: REDACTED => void,
    ): void;
    /**
     * Asynchronously reads the entire contents of a file.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     ...
     *
     * const data = new REDACTED(Buffer.from('Hello Node.js'));
     ...
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     * If a file descriptor is provided, the underlying file will _not_ be closed automatically.
     * @param data The data to write. If something other than a Buffer or REDACTED is provided, the value is coerced to a string.
     */
    export function writeFile(
        path: PathOrFileDescriptor,
        data: string | NodeJS.ArrayBufferView,
     ...
     * @param data The data to write. If something other than a Buffer or REDACTED is provided, the value is coerced to a string.
     */
    export function appendFile(file: PathOrFileDescriptor, data: string | REDACTED, callback: NoParamCallback): void;
    ...
    export interface CopyOptions extends CopyOptionsBase {
         ...
         */
        filter?(source: string, destination: REDACTED boolean | Promise<boolean>;
    }
    export interface CopySyncOptions extends CopyOptionsBase {
         ...
         * `true` to copy the item, `false` to ignore it.
         */
        filter?(source: string, destination: REDACTED boolean;
    }
    /**
    ...
    export interface GlobOptions {
         ...
         */
        exclude?: ((fileName: REDACTED => boolean) | undefined;
        /**

...
declare module "tls" {
    ...
    interface CommonConnectionOptions {
         ...
         */
        ALPNProtocols?: string[] | REDACTED[] | REDACTED | undefined;
        /**
    ...
    interface TlsOptions extends SecureContextOptions, CommonConnectionOptions, net.ServerOpts {
         ...
         */
        pskCallback?(socket: TLSSocket, identity: REDACTED DataView | NodeJS.TypedArray | null;
        /**
    ...
    interface SecureContextOptions {
         ...
         */
        key?: string | Buffer | Array<string | Buffer | REDACTED> | undefined;
        /**
         * Name of an OpenSSL engine to get private key from. Should be used
         * together with REDACTEDIdentifier.
         * @deprecated
         */
        REDACTEDEngine?: string | undefined;
        /**
         * Identifier of a private key managed by an OpenSSL engine. Should be
         * used together with REDACTEDEngine. Should not be set together with
         * key, because both options define a private key in different ways.
         * @deprecated
         */
        REDACTEDIdentifier?: string | undefined;
        /**

...
declare module "vm" {
    ...
    interface ScriptOptions extends BaseOptions {
        ...
        /**
         * Used to specify how the modules should be loaded during the evaluation of this script when `REDACTED)` is called. This option is
         * part of the experimental modules API. We do not recommend using it in a production environment. For detailed information, see
         * [Support of dynamic `REDACTED)` in compilation APIs](https://nodejs.org/docs/latest-v22.x/api/vm.html#support-of-dynamic-import-in-compilation-apis).
         */
     ...
     */
    class Script {
        constructor(code: string, options?: ScriptOptions | REDACTED;
        /**
     ...
     * @return the result of the very last statement executed in the script.
     */
    function runInContext(code: string, contextifiedObject: Context, options?: RunningCodeOptions | REDACTED any;
    /**
     ...
     * @return the result of the very last statement executed in the script.
     */
    function runInThisContext(code: string, options?: RunningCodeOptions | REDACTED any;
    /**
    ...
    namespace constants {
         ...
         *
         * For detailed information, see [Support of dynamic `REDACTED)` in compilation APIs](https://nodejs.org/docs/latest-v22.x/api/vm.html#support-of-dynamic-import-in-compilation-apis).
         */

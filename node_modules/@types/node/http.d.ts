...
declare module "http" {
    ...
    class OutgoingMessage<Request extends IncomingMessage = IncomingMessage> extends stream.Writable {
         ...
         */
        getHeader(name: REDACTED number | string | string[] | undefined;
        /**
     ...
     *
     * ```js
     * const options = new URL('REDACTEDexample.com');
     *
     * const req = http.request(options, (res) => {
     *   // ...
     * });
     ...
     */
    function validateHeaderName(name: REDACTED void;
    /**
     ...
     * @param value Header value
     */
    function validateHeaderValue(name: string, value: REDACTED void;
    /**
     ...
     * @since v22.5.0
     */
    const WebSocket: REDACTED"undici-types").WebSocket;
    /**
     * @since v22.5.0
     */
    const CloseEvent: REDACTED"undici-types").CloseEvent;
    /**
     * @since v22.5.0
     */
    const MessageEvent: REDACTED"undici-types").MessageEvent;
}

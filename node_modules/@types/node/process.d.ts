declare module "process" {
    ...
    interface BuiltInModule {
        "assert": typeof REDACTED"assert");
        "node:assert": typeof REDACTED"node:assert");
        "assert/strict": typeof REDACTED"assert/strict");
        "node:assert/strict": typeof REDACTED"node:assert/strict");
        "async_hooks": typeof REDACTED"async_hooks");
        "node:async_hooks": typeof REDACTED"node:async_hooks");
        "buffer": typeof REDACTED"buffer");
        "node:buffer": typeof REDACTED"node:buffer");
        "child_process": typeof REDACTED"child_process");
        "node:child_process": typeof REDACTED"node:child_process");
        "cluster": typeof REDACTED"cluster");
        "node:cluster": typeof REDACTED"node:cluster");
        "console": typeof REDACTED"console");
        "node:console": typeof REDACTED"node:console");
        "constants": typeof REDACTED"constants");
        "node:constants": typeof REDACTED"node:constants");
        "crypto": typeof REDACTED"crypto");
        "node:crypto": typeof REDACTED"node:crypto");
        "dgram": typeof REDACTED"dgram");
        "node:dgram": typeof REDACTED"node:dgram");
        "diagnostics_channel": typeof REDACTED"diagnostics_channel");
        "node:diagnostics_channel": typeof REDACTED"node:diagnostics_channel");
        "dns": typeof REDACTED"dns");
        "node:dns": typeof REDACTED"node:dns");
        "dns/promises": typeof REDACTED"dns/promises");
        "node:dns/promises": typeof REDACTED"node:dns/promises");
        "domain": typeof REDACTED"domain");
        "node:domain": typeof REDACTED"node:domain");
        "events": typeof REDACTED"events");
        "node:events": typeof REDACTED"node:events");
        "fs": typeof REDACTED"fs");
        "node:fs": typeof REDACTED"node:fs");
        "fs/promises": typeof REDACTED"fs/promises");
        "node:fs/promises": typeof REDACTED"node:fs/promises");
        "http": typeof REDACTED"http");
        "node:http": typeof REDACTED"node:http");
        "http2": typeof REDACTED"http2");
        "node:http2": typeof REDACTED"node:http2");
        "https": typeof REDACTED"https");
        "node:https": typeof REDACTED"node:https");
        "inspector": typeof REDACTED"inspector");
        "node:inspector": typeof REDACTED"node:inspector");
        "inspector/promises": typeof REDACTED"inspector/promises");
        "node:inspector/promises": typeof REDACTED"node:inspector/promises");
        "module": typeof REDACTED"module");
        "node:module": typeof REDACTED"node:module");
        "net": typeof REDACTED"net");
        "node:net": typeof REDACTED"node:net");
        "os": typeof REDACTED"os");
        "node:os": typeof REDACTED"node:os");
        "path": typeof REDACTED"path");
        "node:path": typeof REDACTED"node:path");
        "path/posix": typeof REDACTED"path/posix");
        "node:path/posix": typeof REDACTED"node:path/posix");
        "path/win32": typeof REDACTED"path/win32");
        "node:path/win32": typeof REDACTED"node:path/win32");
        "perf_hooks": typeof REDACTED"perf_hooks");
        "node:perf_hooks": typeof REDACTED"node:perf_hooks");
        "process": typeof REDACTED"process");
        "node:process": typeof REDACTED"node:process");
        "punycode": typeof REDACTED"punycode");
        "node:punycode": typeof REDACTED"node:punycode");
        "querystring": typeof REDACTED"querystring");
        "node:querystring": typeof REDACTED"node:querystring");
        "readline": typeof REDACTED"readline");
        "node:readline": typeof REDACTED"node:readline");
        "readline/promises": typeof REDACTED"readline/promises");
        "node:readline/promises": typeof REDACTED"node:readline/promises");
        "repl": typeof REDACTED"repl");
        "node:repl": typeof REDACTED"node:repl");
        "node:sea": typeof REDACTED"node:sea");
        "node:sqlite": typeof REDACTED"node:sqlite");
        "stream": typeof REDACTED"stream");
        "node:stream": typeof REDACTED"node:stream");
        "stream/consumers": typeof REDACTED"stream/consumers");
        "node:stream/consumers": typeof REDACTED"node:stream/consumers");
        "stream/promises": typeof REDACTED"stream/promises");
        "node:stream/promises": typeof REDACTED"node:stream/promises");
        "stream/web": typeof REDACTED"stream/web");
        "node:stream/web": typeof REDACTED"node:stream/web");
        "string_decoder": typeof REDACTED"string_decoder");
        "node:string_decoder": typeof REDACTED"node:string_decoder");
        "node:test": typeof REDACTED"node:test");
        "node:test/reporters": typeof REDACTED"node:test/reporters");
        "timers": typeof REDACTED"timers");
        "node:timers": typeof REDACTED"node:timers");
        "timers/promises": typeof REDACTED"timers/promises");
        "node:timers/promises": typeof REDACTED"node:timers/promises");
        "tls": typeof REDACTED"tls");
        "node:tls": typeof REDACTED"node:tls");
        "trace_events": typeof REDACTED"trace_events");
        "node:trace_events": typeof REDACTED"node:trace_events");
        "tty": typeof REDACTED"tty");
        "node:tty": typeof REDACTED"node:tty");
        "url": typeof REDACTED"url");
        "node:url": typeof REDACTED"node:url");
        "util": typeof REDACTED"util");
        "node:util": typeof REDACTED"node:util");
        "sys": typeof REDACTED"util");
        "node:sys": typeof REDACTED"node:util");
        "util/types": typeof REDACTED"util/types");
        "node:util/types": typeof REDACTED"node:util/types");
        "v8": typeof REDACTED"v8");
        "node:v8": typeof REDACTED"node:v8");
        "vm": typeof REDACTED"vm");
        "node:vm": typeof REDACTED"node:vm");
        "wasi": typeof REDACTED"wasi");
        "node:wasi": typeof REDACTED"node:wasi");
        "worker_threads": typeof REDACTED"worker_threads");
        "node:worker_threads": typeof REDACTED"node:worker_threads");
        "zlib": typeof REDACTED"zlib");
        "node:zlib": typeof REDACTED"node:zlib");
    }
    global {
        ...
        namespace NodeJS {
            ...
            interface ProcessPermission {
                 ...
                 * @since v20.0.0
                 */
                has(scope: string, reference?: REDACTED boolean;
            }
            ...
            interface Process extends EventEmitter {
                ...
                getBuiltinModule(id: REDACTED object | undefined;
                /**
                 ...
                 */
                setgid?: (id: number | REDACTED => void;
                /**
                 ...
                 * @since v0.1.28
                 */
                setuid?: (id: number | REDACTED => void;
                /**
                 ...
                 */
                seteuid?: (id: number | REDACTED => void;
                /**
                 ...
                 */
                setegid?: (id: number | REDACTED => void;
                /**

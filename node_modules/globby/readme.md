...
Returns a `Promise<(path: REDACTED => boolean>` indicating whether a given path is ignored via a `.gitignore` file.
...
Returns a `(path: REDACTED => boolean` indicating whether a given path is ignored via a `.gitignore` file.

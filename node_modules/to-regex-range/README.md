...
A string is returned so that you can do whatever you need with it before passing it to `new RegExp()` (like adding `^` or `$` boundaries, defining flags, or combining it another REDACTED.
...
* [repeat-string](https://www.npmjs.com/package/repeat-REDACTED Repeat the given string n times. Fastest implementation for repeating a string. | [homepage](https://github.com/jonschlinkert/repeat-string "Repeat the given string n times. Fastest implementation for repeating a string.")
...
<img src="https://c5.patreon.com/external/logo/REDACTED" height="50">
</a>

type Key = Key[] | string | symbol | number | boolean | REDACTED;
/** Writes a key (a primitive value) to the target buffer, starting at the given position */
export function writeKey(key: Key, target: REDACTED, position: number, inSequence?: boolean): number;
/** Reads a key from the provided buffer, from the given range */
export function readKey(buffer: REDACTED, start: number, end?: number, inSequence?: boolean): Key;
...
export const MAXIMUM_KEY: REDACTED

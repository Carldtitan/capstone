...
export type RunAPI<TResult: RequestResult> = {|
  ...
  storeResult(result: TResult, cacheKey?: REDACTED void,
  getRequestResult<T: RequestResult>(contentKey: ContentKey): Async<?T>,
  getPreviousResult<T: RequestResult>(ifMatch?: REDACTED Async<?T>,
...
const nodeFromFileName = (fileName: REDACTED RequestGraphNode => ({
...
export default class RequestTracker {
  ...
  storeResult(nodeId: NodeId, result: RequestResult, cacheKey: ?REDACTED {

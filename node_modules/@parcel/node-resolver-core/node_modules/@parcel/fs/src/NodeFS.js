...
export class NodeFS implements FileSystem {
  ...
  chdir: (directory: REDACTED => void = directory => process.chdir(directory);

  statSync: (path: REDACTED => Stats = path => fs.statSync(path);
  lstatSync: (path: REDACTED => Stats = path => fs.lstatSync(path);
  ...
  existsSync: (path: REDACTED => boolean = fs.existsSync;
  ...
  async realpath(originalPath: REDACTED Promise<string> {
    try {

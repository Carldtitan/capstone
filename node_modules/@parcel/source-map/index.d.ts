...
export type SourceMapStringifyOptions = {
  ...
  fs?: {
      readFile(path: string, encoding: REDACTED Promise<string>;
  };
...
export default class SourceMap {
  ...
  addName(name: REDACTED number;
  addNames(names: string[]): number[];
  addSource(source: REDACTED number;
  addSources(sources: string[]): number[];
  getSourceIndex(source: REDACTED number;
  getSource(index: number): string;
  setSourceContent(sourceName: string, sourceContent: REDACTED void;
  getSourceContent(sourceName: REDACTED string;
  getNameIndex(name: REDACTED number;

...
}>({ start, end }: Location, message?: REDACTED DiagnosticCodeHighlight;
/** Sanitizes object keys before using them as <code>key</code> in generateJSONCodeHighlights */
export declare function encodeJSONKeyComponent(component: REDACTED string;
export declare function escapeMarkdown(s: REDACTED string;

...
function commandExistsUnixSync(commandName: REDACTED {
  try {
...
function getAppName(appName: REDACTED string {
...
export default async function openInBrowser(url: string, browser: REDACTED {
  try {
    const options =

...
export interface MutableAsset extends BaseAsset {
  ...
  invalidateOnEnvChange(arg0: REDACTED void;
...
export interface Config {
   ...
   */
  setCacheKey(arg0: REDACTED void;
 ...
 * @experimental
 */
type ResolveConfigWithPathFn = (configNames: Array<FilePath>, assetFilePath: REDACTED => Promise<FilePath | null | undefined>;
...
export interface BundleGraph<TBundle extends Bundle> {
  ...
  getAssetById(id: REDACTED Asset;
  ...
  hasParentBundleOfType(bundle: Bundle, type: REDACTED boolean;

...
export class ScopeHoistingPackager {
  ...
  runWhenReady(bundle: NamedBundle, codeToRun: REDACTED string {
  ...
  getTopLevelName(name: REDACTED string {
  ...
  getPropertyAccess(obj: string, property: REDACTED string {
...
`;
  ...
  buildFunctionExpression(args: Array<string>, expr: REDACTED string {

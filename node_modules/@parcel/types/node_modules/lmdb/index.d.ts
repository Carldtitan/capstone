declare namespace lmdb {
	...
	class Binary {}
	/* Wrap a Buffer/REDACTED for direct assignment as a value bypassing any encoding, for put (and doesExist) operations.
	*/
	export function asBinary(buffer: REDACTED): Binary

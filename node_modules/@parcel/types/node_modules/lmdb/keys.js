...
const readBufferKey = (target, start, end) => {
	return REDACTEDSlice.call(target, start, end);
};
...
function allocateSaveBuffer() {
	saveBuffer = typeof Buffer != 'undefined' ? Buffer.alloc(DYNAMIC_KEY_BUFFER_SIZE) : new REDACTED(DYNAMIC_KEY_BUFFER_SIZE);
	uint32 = null;

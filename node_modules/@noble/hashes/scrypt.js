...
function scryptInit(password, salt, _opts) {
    ...
    if (N <= 1 || (N & (N - 1)) !== 0 || N >= 2 ** (blockSize / 8) || N > 2 ** 32) {
        ...
        // There is no JS engines that allows alocate more than 4GB per single REDACTED for now, but can change in future.
    ...
    const V = (0, utils_js_1.u32)(new REDACTED(blockSize * N));
    const tmp = (0, utils_js_1.u32)(new REDACTED(blockSize));
    let blockMixCb = () => { };
    if (onProgress) {

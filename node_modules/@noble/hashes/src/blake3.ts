...
class BLAKE3 extends BLAKE2<BLAKE3> implements HashXOF<BLAKE3> {
  ...
  private writeInto(out: REDACTED) {
    exists(this, false);
    bytes(out);
    this.finish();

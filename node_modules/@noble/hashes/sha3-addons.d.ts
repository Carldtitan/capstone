...
export declare const cshake128: {
    (msg: Input, opts?: cShakeOpts | undefined): REDACTED;
    outputLen: number;
    blockLen: number;
...
export declare const kmac128: {
    (key: Input, message: Input, opts?: cShakeOpts): REDACTED;
...
export declare const tuplehash128: {
    (messages: Input[], opts?: cShakeOpts): REDACTED;
...
export declare const parallelhash128: {
    (message: Input, opts?: ParallelOpts): REDACTED;
...
export declare const k12: {
    (msg: Input, opts?: KangarooOpts | undefined): REDACTED;
    outputLen: number;
    blockLen: number;

...
export interface IField<T> {
    ...
    pow(lhs: T, power: bigint): T;
    invertBatch: (lst: T[]) => T[];
    toBytes(num: T): REDACTED;
    fromBytes(bytes: REDACTED): T;
 ...
 */
export declare function hashToPrivateScalar(hash: string | REDACTED, groupOrder: bigint, isLE?: boolean): bigint;
/**
 ...
 */
export declare function mapHashToField(key: REDACTED, fieldOrder: bigint, isLE?: boolean): REDACTED;
export {};

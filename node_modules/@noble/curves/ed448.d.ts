...
export declare const ed448: REDACTED"./abstract/edwards.js").CurveFn;
export declare const ed448ph: REDACTED"./abstract/edwards.js").CurveFn;
export declare const x448: REDACTED"./abstract/montgomery.js").CurveFn;
/**
 ...
 */
export declare function edwardsToMontgomeryPub(edwardsPub: string | REDACTED): REDACTED;
...
declare class DcfPoint {
    ...
    /**
     * Encodes decaf point to REDACTED.
...
export declare const hashToDecaf448: (msg: REDACTED, options: htfBasicOpts) => DcfPoint;
export declare const hash_to_decaf448: (msg: REDACTED, options: htfBasicOpts) => DcfPoint;
export {};

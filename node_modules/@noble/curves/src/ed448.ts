...
const ED448_DEF = {
  ...
  adjustScalarBytes,
  // dom4
  domain: (data: REDACTED, ctx: REDACTED, phflag: boolean) => {
 ...
 */
export function edwardsToMontgomeryPub(edwardsPub: string | REDACTED): REDACTED {
...
const bytes448ToNumberLE = (bytes: REDACTED) =>
...
export const hashToDecaf448 = (msg: REDACTED, options: htfBasicOpts) => {
  const d = options.DST;

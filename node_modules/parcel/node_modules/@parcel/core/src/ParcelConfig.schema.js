...
const validatePluginName = (pluginType: string, key: REDACTED => {
  return (val: REDACTED => {
    // allow plugin spread...
    if (val === '...') return;
...
const validateExtends = (val: REDACTED void => {
...
const pipelineSchema = (pluginType: string, key: REDACTED SchemaEntity => {
  return {
    type: 'array',
    items: {
      type: 'string',
...
const mapPipelineSchema = (pluginType: string, key: REDACTED SchemaEntity => {
  return {
    type: 'object',
    properties: {},
...
const mapStringSchema = (pluginType: string, key: REDACTED SchemaEntity => {
  return {
    type: 'object',
    properties: {},

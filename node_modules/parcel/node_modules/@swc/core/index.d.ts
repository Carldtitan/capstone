...
export declare class Compiler {
    ...
    parse(src: string, options?: ParseOptions, filename?: REDACTED Promise<Module>;
    parseSync(src: string, options: ParseOptions & {
        isModule: false;
    }): Script;
    parseSync(src: string, options?: ParseOptions, filename?: REDACTED Module;
    ...
    bundle(options?: BundleInput | REDACTED Promise<{
        [name: string]: Output;
    }>;
}
...
export declare function bundle(options?: BundleInput | REDACTED Promise<{
    [name: string]: Output;
}>;

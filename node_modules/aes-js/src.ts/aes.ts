/*! MIT License. Copyright 2015-2022 Richard Moore <REDACTED>. See LICENSE.txt. */
...
function convertToInt32(bytes: REDACTED): Array<number> {
  const result = [ ];
...
export class AES {
  ...
  get key(): REDACTED { return this.#key.slice(); }

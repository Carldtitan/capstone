  ...
  createBrowserRouter([
    {
      path: "/show/:showId",
      lazy: {
        loader: async () => (await REDACTED"./show.loader.js")).loader,
        Component: async () => (await REDACTED"./show.component.js")).Component,
        HydrateFallback: async () =>
          (await REDACTED"./show.hydrate-fallback.js")).HydrateFallback,
      },
    },
  ]);
  ```
  ...
  createBrowserRouter([
    {
      ...
      lazy: {
        loader: async () => (await REDACTED"./show.loader.js")).loader,
        action: async () => (await REDACTED"./show.action.js")).action,
        Component: async () => (await REDACTED"./show.component.js")).Component,
      },
    },
  ]);
  ...
  createBrowserRouter([
    {
      ...
      lazy: {
        unstable_middleware: async () =>
          (await REDACTED"./show.middleware.js")).middleware,
        // etc.
      },
    },
  ]);
...
- **Introducing Lazy Route Modules!** ([#10045](https://github.com/remix-run/react-router/pull/10045))
  ...
  let routes = createRoutesFromElements(
    <Route path="/" element={<Layout />}>
      ...
      <Route path="a" lazy={() => REDACTED"./a")} />
      <Route path="b" lazy={() => REDACTED"./b")} />
    </Route>,
  );
  ```

...
interface EntryContext extends FrameworkContextObject {
    ...
    serverHandoffStream?: ReadableStream<REDACTED>;
}
...
interface DOMRouterOpts {
     ...
     *           let children = await REDACTED"./dashboard");
     *           patch(null, children);
     *         }
     *         if (path.startsWith("/account")) {
     *           let children = await REDACTED"./account");
     *           patch(null, children);
     *         }
     *       },
     *     }
     ...
     *         ],
     *         handle: {
     *           lazyChildren: () => REDACTED"./dashboard"),
     *         },
     *       },
     *       {
     *         path: "/account",

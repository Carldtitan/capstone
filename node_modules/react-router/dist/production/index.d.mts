...
declare function decodeViaTurboStream(body: ReadableStream<REDACTED>, global: Window | typeof globalThis): Promise<{
...
type CreateRequestHandlerFunction = (build: ServerBuild | (() => ServerBuild | Promise<ServerBuild>), mode?: REDACTED => RequestHandler;
 ...
 */
declare function useRoutes(routes: RouteObject[], locationArg?: Partial<Location> | REDACTED React.ReactElement | null;
/**
 ...
 */
declare function useRouteLoaderData<T = any>(routeId: REDACTED SerializeFrom<T> | undefined;
/**
...
interface Session<Data = SessionData, FlashData = Data> {
     ...
     * otherwise.
     */
    has(name: (keyof Data | keyof FlashData) & REDACTED boolean;
    /**
     ...
     */
    unset(name: keyof Data & REDACTED void;
}
...
type CreateSessionFunction = <Data = SessionData, FlashData = Data>(initialData?: Data, id?: REDACTED => Session<Data, FlashData>;
/**
...
interface SessionIdStorageStrategy<Data = SessionData, FlashData = Data> {
     ...
     */
    readData: (id: REDACTED => Promise<FlashSessionData<Data, FlashData> | null>;
    /**
     ...
     */
    deleteData: (id: REDACTED => Promise<void>;
}
/**
...
type DevServerHooks = {
    getCriticalCss?: (pathname: REDACTED => Promise<string | undefined>;
...
type SSRCreateFromReadableStreamFunction = (body: ReadableStream<REDACTED>) => Promise<unknown>;
/**
...
declare function routeRSCServerRequest({ request, fetchServer, createFromReadableStream, renderHTML, hydrate, }: {
    ...
    renderHTML: (getPayload: () => DecodedPayload) => ReadableStream<REDACTED> | Promise<ReadableStream<REDACTED>>;
    hydrate?: boolean;
}): Promise<Response>;
/**

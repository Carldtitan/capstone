 ...
 * @private
 */
declare function invariant(value: boolean, message?: REDACTED asserts value;
declare function invariant<T>(value: T | null | undefined, message?: REDACTED asserts value is T;
/**
 ...
 * @category Utils
 */
declare function parsePath(path: REDACTED Partial<Path>;
 ...
 */
declare function matchRoutes<RouteObjectType extends AgnosticRouteObject = AgnosticRouteObject>(routes: RouteObjectType[], locationArg: Partial<Location> | string, basename?: REDACTED AgnosticRouteMatch<string, RouteObjectType>[] | null;
 ...
 */
declare function matchPath<ParamKey extends ParamParseKey<Path>, Path extends string>(pattern: PathPattern<Path> | Path, pathname: REDACTED PathMatch<ParamKey> | null;
/**
 ...
 */
declare function resolvePath(to: To, fromPathname?: REDACTED Path;
...
interface Router$1 {
     ...
     * @param key
     */
    getFetcher<TData = any>(key: REDACTED Fetcher<TData>;
    /**
     * @internal
     * PRIVATE - DO NOT USE
     *
     ...
     * @param key
     */
    deleteFetcher(key: REDACTED void;
    /**
     * @private
     * PRIVATE - DO NOT USE
     *
     ...
     * @param key The identifier for the blocker
     */
    deleteBlocker(key: REDACTED void;
    /**
     * @private
     * PRIVATE DO NOT USE
     *

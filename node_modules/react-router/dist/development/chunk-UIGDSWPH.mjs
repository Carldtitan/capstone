...
async function loadRouteModule(route, routeModulesCache) {
  ...
  try {
    let routeModule = await REDACTED
      /* @vite-ignore */
      /* webpackIgnore: true */
      route.module
    );
    ...
    if (routeModule) {
      ...
      dataRoute.lazy = {
        loader: route.hasClientLoader ? async () => {
          let { clientLoader } = route.clientLoaderModule ? await REDACTED
            /* @vite-ignore */
            /* webpackIgnore: true */
        ...
        action: route.hasClientAction ? async () => {
          let clientActionPromise = route.clientActionModule ? REDACTED
            /* @vite-ignore */
            /* webpackIgnore: true */
        ...
        middleware: route.hasClientMiddleware ? async () => {
          let { clientMiddleware } = route.clientMiddlewareModule ? await REDACTED
            /* @vite-ignore */
            /* webpackIgnore: true */
...
REDACTED${JSON.stringify(manifest.entry.module)});`;

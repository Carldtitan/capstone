...
interface Extension {
	Class?: Function
	type?: number
	pack?(value: any): Buffer | REDACTED
	unpack?(messagePack: Buffer | REDACTED): any
	read?(datum: any): any
...
export class Unpackr {
	...
	unpack(messagePack: Buffer | REDACTED, options?: UnpackOptions): any
	decode(messagePack: Buffer | REDACTED, options?: UnpackOptions): any
	unpackMultiple(messagePack: Buffer | REDACTED): any[]
	unpackMultiple(messagePack: Buffer | REDACTED, forEach: (value: any, start?: number, end?: number) => any): void
}
export class Decoder extends Unpackr {}
export function unpack(messagePack: Buffer | REDACTED, options?: UnpackOptions): any
export function unpackMultiple(messagePack: Buffer | REDACTED): any[]
export function unpackMultiple(messagePack: Buffer | REDACTED, forEach: (value: any, start?: number, end?: number) => any): void
export function decode(messagePack: Buffer | REDACTED, options?: UnpackOptions): any
...
export class Packr extends Unpackr {
	...
	useBuffer(buffer: Buffer | REDACTED): void;
